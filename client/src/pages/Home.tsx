  ...
  return <>
    ...
    <section className="hero-section">
      ...
      <div className="container hero-layout">
        ...
        <div className="hero-art"><div className="hero-orbit orbit-a"><span className="hero-signal-dot dot-green" /></div><div className="hero-orbit orbit-b"><span className="hero-signal-dot dot-violet" /></div><div className="hero-image-frame"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663923627772/okYRpvrSlQAxMEsw.png" alt={lang === "en" ? "Abstract enterprise intelligence network with connected data signals" : lang === "zh-CN" ? "连接数据讯号的抽象企业智能网络" : "連結資料訊號的抽象企業智慧網路"} /><div className="hero-art-overlay" /></div><svg className="hero-signal-overlay" viewBox="0 0 800 520" preserveAspectRatio="none" aria-hidden="true"><path className="hero-signal-path path-cyan" d="M-30 378 C120 328 132 184 286 226 S470 370 610 226 S730 130 830 162" /><path className="hero-signal-path path-mint" d="M-30 116 C112 156 172 320 314 286 S484 116 628 180 S742 318 830 278" /><path className="hero-signal-path path-violet" d="M-24 444 C140 408 226 354 344 382 S542 468 824 350" /><circle className="hero-signal-node node-cyan" cx="286" cy="226" r="3" /><circle className="hero-signal-node node-mint" cx="314" cy="286" r="3" /><circle className="hero-signal-node node-violet" cx="542" cy="420" r="3" /></svg></div>
      </div>
    </section>
    <HomeAbout />
